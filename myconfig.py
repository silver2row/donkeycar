...
PCA9685_I2C_ADDR = 0x54     #I2C address, use i2cdetect to validate this number
PCA9685_I2C_BUSNUM = "/dev/bone/i2c-5"   #None will auto detect, which is fine on the pi. But other platforms should specify the bus num.
# 
# #SSD1306_128_32
...
# #
PWM_STEERING_THROTTLE = {
     "PWM_STEERING_PIN": "PCA9685.5:40.1",   # PWM output pin for steering servo
...
VESC_SERIAL_PORT= "/dev/ttyS2" # Serial device to use for communication. Can check with ls /dev/tty*
